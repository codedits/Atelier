        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 pb-12 border-b border-[#E5E5E5]">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="mailto:hello@atelier.com" className="text-xs text-[#6B6B6B] hover:text-[#D4A5A5] transition-colors duration-150">hello@atelier.com</a></li>
              <li><a href="tel:+923001234567" className="text-xs text-[#6B6B6B] hover:text-[#D4A5A5] transition-colors duration-150">+92 (300) 123-4567</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/products" className="text-sm text-[#6B6B6B] hover:text-[#D4A5A5] transition-colors duration-150">All Products</Link></li>
              <li><Link href="/products?category=rings" className="text-sm text-[#6B6B6B] hover:text-[#D4A5A5] transition-colors duration-150">Rings</Link></li>
              <li><Link href="/products?category=necklaces" className="text-sm text-[#6B6B6B] hover:text-[#D4A5A5] transition-colors duration-150">Necklaces</Link></li>
              <li><Link href="/products?category=bracelets" className="text-sm text-[#6B6B6B] hover:text-[#D4A5A5] transition-colors duration-150">Bracelets</Link></li>
              <li><Link href="/products?category=earrings" className="text-sm text-[#6B6B6B] hover:text-[#D4A5A5] transition-colors duration-150">Earrings</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-3 mb-6">
              <a href="https://instagram.com/atelier" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-10 h-10 rounded-full border border-[#E5E5E5] flex items-center justify-center text-[#6B6B6B] hover:text-[#D4A5A5] hover:border-[#D4A5A5] transition-colors duration-150">
              ...
              <a href="https://pinterest.com/atelier" target="_blank" rel="noopener noreferrer" aria-label="Pinterest" className="w-10 h-10 rounded-full border border-[#E5E5E5] flex items-center justify-center text-[#6B6B6B] hover:text-[#D4A5A5] hover:border-[#D4A5A5] transition-colors duration-150">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://facebook.com/atelier" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-10 h-10 rounded-full border border-[#E5E5E5] flex items-center justify-center text-[#6B6B6B] hover:text-[#D4A5A5] hover:border-[#D4A5A5] transition-colors duration-150">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="https://twitter.com/atelier" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="w-10 h-10 rounded-full border border-[#E5E5E5] flex items-center justify-center text-[#6B6B6B] hover:text-[#D4A5A5] hover:border-[#D4A5A5] transition-colors duration-150">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://youtube.com/@atelier" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="w-10 h-10 rounded-full border border-[#E5E5E5] flex items-center justify-center text-[#6B6B6B] hover:text-[#D4A5A5] hover:border-[#D4A5A5] transition-colors duration-150">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
