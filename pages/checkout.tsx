...
export default function CheckoutPage() {
  ...
  // Delivery fee from settings (fallback to 500)
    ...
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="poppins-only">
          ...
          {orderCompleted && (
            <div
              className="bg-gradient-to-r from-green-50 to-emerald-50 border-b border-green-200 px-6 py-4 animate-in slide-in-from-top-4 duration-500"
            >
          ...
          <main className="pt-24 pb-20">
            <div className="max-w-6xl mx-auto px-6 lg:px-8">
              <h1
                className="text-3xl font-medium text-[#111827] mb-8 animate-in fade-in slide-in-from-bottom-2 duration-500"
              >
                Checkout
              </h1>
              ...
              <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
                  ...
                  <div className="lg:col-span-2 space-y-6 lg:space-y-8">
                    {/* Contact Information */}
                    <div
                      className="bg-[#F8F7F5] rounded-lg p-6 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-100 fill-mode-both"
                    >
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-4 py-3 border border-gray-200 rounded focus:outline-none focus:border-[#1A1A1A] transition-colors"
                    ...
                    {/* Shipping Address */}
                    <div
                      className="bg-[#F8F7F5] rounded-lg p-6 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-200 fill-mode-both"
                    >
                      ...
                      <div className="space-y-3 sm:space-y-4">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm border border-gray-200 rounded focus:outline-none focus:border-[#1A1A1A] transition-colors"
                    ...
                    {/* Payment Method */}
                    <div
                      className="bg-[#F8F7F5] rounded-lg p-6 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-300 fill-mode-both"
                    >
                    ...
                    {formData.paymentMethod === 'COD' && showPaymentForm && (
                      <div
                        className="bg-[#FFF7ED] border border-[#FED7AA] rounded-lg p-6 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-100 fill-mode-both"
                      >
                            ...
                            <div className="grid gap-2">
                              ...
                              <label className="flex items-center gap-3 p-3 border border-gray-200 rounded cursor-pointer hover:border-amber-500 transition-colors">
                                ...
                                <div>
                                  ...
                                  <p className="text-sm text-gray-600 font-mono">{storeSettings.jazzcash_number}</p>
                                </div>
                              </label>
                              )}
                              {storeSettings.easypaisa_number && (
                              <label className="flex items-center gap-3 p-3 border border-gray-200 rounded cursor-pointer hover:border-amber-500 transition-colors">
                                <input
                                  type="radio"
                                  name="paymentProofMethod"
                                ...
                                <div>
                                  ...
                                  <p className="text-sm text-gray-600 font-mono">{storeSettings.easypaisa_number}</p>
                                </div>
                              </label>
                              )}
                              ...
                              <label className="flex items-center gap-3 p-3 border border-gray-200 rounded cursor-pointer hover:border-amber-500 transition-colors">
                                ...
                                />
                                <div>
                                  <p className="font-medium text-gray-800">Bank Transfer{storeSettings.bank_name ? ` (${storeSettings.bank_name})` : ''}</p>
                                  <p className="text-sm text-gray-600">
                                    <span className="font-mono block">Account: {storeSettings.bank_account}</span>
                                    {storeSettings.bank_holder && <span className="block">Name: {storeSettings.bank_holder}</span>}
                                    {storeSettings.bank_iban && <span className="font-mono block">IBAN: {storeSettings.bank_iban}</span>}
                                  </p>
                                </div>
                              </label>
                              )}
                              {!storeSettings.jazzcash_number && !storeSettings.easypaisa_number && !storeSettings.bank_account && (
                                <p className="text-sm text-amber-700 p-3 bg-amber-50 rounded">Payment details are being configured. Please contact us to complete your order.</p>
                              )}
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="lg:col-span-1 order-first lg:order-last">
                    <div
                      className="bg-[#F8F7F5] rounded-lg p-4 sm:p-6 lg:sticky lg:top-24 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-200 fill-mode-both"
                    >
                      ...
                      {submitting && (
                        <div className="mb-4">
                          <div className="flex justify-between items-center mb-2">
                            ...
                            <span className="text-xs font-medium text-[#1A1A1A]">{Math.round(loadingProgress)}%</span>
                          </div>
                          <div className="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
                            <div
                              className="bg-gradient-to-r from-[#1A1A1A] to-red-400 h-full rounded-full transition-all duration-300"
      ...
      {showThankYou && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-[9999] p-4">
          <div
            className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-8 text-center relative overflow-hidden animate-in zoom-in-95 slide-in-from-bottom-8 duration-500"
          >
            ...
            {/* Checkmark Icon */}
            <div
              className="w-24 h-24 rounded-full bg-green-100 flex items-center justify-center mx-auto mb-6 shadow-lg animate-in zoom-in duration-500 delay-200 fill-mode-both"
            >
              <svg
