    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-24 pb-20">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <h1 className="text-3xl font-medium text-[#111827] mb-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            Shopping Cart
          </h1>
              ...
              {items.map((item, index) => (
                ...
                >
                  ...
                  <div className="text-right w-full sm:w-auto">
                    <p className="text-xs text-[#6B7280] mb-2 sm:hidden">Line Total</p>
